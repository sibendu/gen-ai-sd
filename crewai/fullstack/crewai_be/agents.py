...
class CompanyResearchAgents():
    ...
    def __init__(self):
        ...
        #print("Init CompanyResearchAgents")
    ...
    def research_manager(self, companies: List[str], positions: List[str]) -> Agent:
        #print("Inside research_manager()") 
        #print(companies)
        #print(positions) 
        #print(self.llm)
        #print(self.searchInternetTool)
        #print(self.youtubeSearchTool) 
        ...
        #print(research_manager_agent)
        return research_manager_agent  
